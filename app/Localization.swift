...
extension Loc {
    ...
    static let zh: [String: String] = [
        ...
        "When enabled, each promoted Side-button external voice hold is saved locally as WAV plus capture metadata. If the input method changes the clipboard after that utterance, HyperVibe stores the observed text separately. Native Voice does not need to be enabled.": "开启后，每次侧键成功进入外部语音长按都会在本机保存为 WAV 音频和采集元数据。如果输入法在这次说话后修改了剪贴板，HyperVibe 会把观察到的文字单独保存。无需开启原生语音。",
        "Output mode": "输出模式",
